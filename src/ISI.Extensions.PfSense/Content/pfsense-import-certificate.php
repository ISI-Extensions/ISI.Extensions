...
/**
 * From: https://github.com/stompro/pfsense-import-certificate/blob/master/pfsense-import-certificate.php
...
if ($argc != 4) {
	echo "Usage: php " . $argv[0] . " /path/to/fullchain.pem /path/to/key.pem certificate-name";
	die(1);
}
